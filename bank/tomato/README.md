...
- **更新日**: 2026-08-21
- **Backlogプロジェクト**: [TMT_IBPJ](https://sbinbs.backlog.com/projects/TMT_IBPJ)
...
| 口座開設・ローン連携 | [TMT_IBPJ-23](https://sbinbs.backlog.com/view/TMT_IBPJ-23) | 処理中 | ローン申込有無フラグ追加と口座種別の読み替えを確認中。8/20に仕様確定 |
